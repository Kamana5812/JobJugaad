...
- Every table query must filter by `college_id` (multi-tenancy — see `ARCHITECTURE.md`).
...
- **Never claim a rule-based score is a trained ML model.** Document actual logic honestly in code comments and in `ARCHITECTURE.md` — judges will ask.
...
- Don't build the P2 Simulator or chatbot before P0's matching and scheduling work end-to-end.
