...
- Below: conversion tables (branch/skill), package stats, at-risk list, conflict alerts.
- Simulator (P2) gets its own dedicated screen — inputs on the left, projected outcome on the right.
...
| AI Career Assistant | "Jugaad Dost 🤝" |
...
- At-Risk flag → contributing factors list + recommended interventions
