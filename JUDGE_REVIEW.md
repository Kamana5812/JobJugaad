...
| How are colleges isolated? | All 18 tenant tables have application filters plus ENABLE/FORCE RLS on reads/writes. Role/ownership checks restrict access within a college. Real institutions still need controlled enrollment instead of self-selected demo colleges. |
