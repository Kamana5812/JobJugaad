...
export default function PlacementModelCard({ signal, evaluation, dirty }) {
  return <div className="space-y-5">
    ...
    {evaluation && <details className="rounded-xl border border-line p-4">
      ...
      <p className="mt-3 text-sm leading-6 text-muted">Campus Recruitment: {evaluation.dataset_rows} public labeled records, {evaluation.train_rows} used for training and {evaluation.test_rows} held out for testing. One fixed stratified split. These results apply to this test sample, not a guarantee for your college.</p>
